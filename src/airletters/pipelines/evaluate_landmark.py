"""Evaluation pipeline for trained MediaPipe Landmark Transformer checkpoints.

Usage::

    python src/airletters/pipelines/evaluate_landmark.py \\
...
from airletters.utils.train_eval_landmark import evaluate_landmark


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Evaluate MediaPipe Landmark Transformer on AirLetters"
    )
    parser.add_argument(
        "--config",
    ...
    parser.add_argument(
        ...
        type=int,
        default=None,
        help="Limit batches for smoke tests.",
    )
    parser.add_argument(
        "--save-plots",
...
def main() -> None:
    ...
    dataloaders, _ = create_landmark_dataloaders(config)
